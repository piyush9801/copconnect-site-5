...
export default function FloatBot() {
  return (
    <motion.a
      ...
      className="fixed bottom-6 right-6 z-50 w-14 h-14 sm:w-16 sm:h-16 rounded-full bg-brand flex items-center justify-center shadow-[0_10px_30px_rgba(232,101,42,0.5)] border-[3px] border-white/30 cursor-pointer"
    >
      <img
